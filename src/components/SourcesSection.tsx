              ...
              {sources.map((source, i) => (
                ...
                >
                  <div className="flex items-center justify-center mb-4 h-12">
                    {source.isSvg ? (
                      <svg className="w-32 h-8 opacity-70 group-hover:opacity-100 transition-opacity" viewBox="0 0 120 20" fill="none" preserveAspectRatio="xMidYMid meet">
